...
![Specimen Passport Modal - Phalaenopsis amabilis]({{ '/assets/images/passportcard1.png' | relative_url }})

<figcaption style="font-size: 0.85rem; color: #b8a894; font-style: italic; margin-top: 6px; margin-bottom: 24px;">
  Specimen Passport Modal displaying botanical records, care parameters, recent hydration indicators, attached imagery, and tabbed operational logs.
</figcaption>
